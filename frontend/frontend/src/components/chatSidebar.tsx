...
const ChatSidebar = ({sidebarOpen, setSidebarOpen, showAllUsers, setShowAllUsers, istyping, typingTimeOut, user, chats, selectedUser, setSelectedUser, handlelogout, loggedInUser, createChat, onlineUsers}: ChatSidebarProps) => {
  ...
  return (
  <aside className={`fixed z-30 sm:static top-0 overflow-hidden left-0 h-full w-80 bg-gray-900 border-r border-gray-700 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} sm:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col`}>
   {/* Header */}
   <div className='p-2 border-b border-gray-700 overflow-hidden'>
